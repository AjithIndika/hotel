<div class="container mt-2"> 
       ...
       <a href="<?php echo base_url('deliver/deliver')?>"> 
    ...
    &MediumSpace;&MediumSpace;  <input type="submit" value="OK" name="deliver_other"  name="doit" value="=" onclick="calculator.display.value = eval(calculator.display.value)" class=" col-sm-3 btn btn-danger font-weight-bold" style="height:80px;font-size:30px">
           </form>  
    ...
    <form name="calculator" method="post" action="">
        <div class="container col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <input type="submit" value="OK" name="deliver_other" class="col-sm-12 btn btn-danger font-weight-bold bst" style="height:80px;font-size:30px">
                </div>
            </div>
        </div>
    </form>
...
<form action="" method="post" >
    <input type="hidden" value="239" name="itemname_id" >
    <input type="text" id="qunt" name="itemqun" class="form-control col-sm-5 mt-2" placeholder="Enter " readonly required style="height: 80px;font-size: 40px">
                ...
                <button type="button"   onclick="one()" class="btn btn-primary col-sm-3 mb-2"><h2>1</h2></button>
                 ...
                 <button type="button"   onclick="eigt()" class="btn btn-primary col-sm-3 mb-2"><h2>8</h2></button>
                  ...
                  <button type="button"   onclick="sero()" class="btn btn-primary col-sm-3 mb-2"><h2>0</h2></button>
                   ...
                   <input type="submit" value="OK" name="deliver_other" class=" col-sm-3 btn btn-danger font-weight-bold" style="height:80px;font-size:30px">
              </form>
        </div>
