<div class="container mt-2"> 
       ...
       <a href="<?php echo base_url('deliver/diliveritem?cat='.$_SESSION['cat'].'')?>"> 
...
<form action="<?php echo base_url('deliver/add')?>" method="post" >
    <input type="hidden" value="<?php echo $this->input->get('name')?>" name="itemname_id" >
                <input type="text" id="qunt" name="itemqun" class="form-control col-sm-5" placeholder="Enter Quntity" readonly required style="height: 80px;font-size: 40px">
