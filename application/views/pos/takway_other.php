<div class="container mt-2"> 
    ...
    &MediumSpace;&MediumSpace;  <input type="submit" value="OK" name="takeway" class=" col-sm-3 btn btn-danger font-weight-bold" name="doit" value="=" onclick="calculator.display.value = eval(calculator.display.value)" style="height:80px;font-size:30px">
           </form>  
    ...
    <form name="calculator" method="post" action="">
        <div class="container col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <input type="submit" value="OK" name="takeway" class="col-sm-12 btn btn-danger font-weight-bold bst" style="height:80px;font-size:30px">
                </div>
            </div>
        </div>
    </form>
...
<form action="" method="post" >
    <input type="hidden" value="239" name="itemname_id" >
             ...
             <input type="submit" value="OK" name="takeway" class=" col-sm-3 btn btn-danger font-weight-bold" style="height:80px;font-size:30px">
